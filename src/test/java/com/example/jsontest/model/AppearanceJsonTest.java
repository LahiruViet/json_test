...
class AppearanceJsonTest {
    ...
    @Autowired
    private JacksonTester<Appearance> jacksonTester;

    @Autowired
    private JacksonTester<List<Appearance>> jacksonTesterList;
    ...
    @Test
    public void testSerializationWithJsonPath() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.url").isEqualTo("https://google.com");
    }

    @Test
    public void testSerializationWithJsonFile() throws IOException {
    ...
    @Test
    public void testListAppearancesSerialization() throws IOException {
    ...
    public void testDeserialization() throws IOException {
        ...
        assertThat(appearance.getUrl()).isEqualTo("https://google.com");
    }
